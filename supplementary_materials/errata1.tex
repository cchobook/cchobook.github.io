...
\begin{document}
    ...
    \begin{Errata}
        ...
        \item[第 147 页，例题 8.14 解答]
            \Orig 平衡时 $K^\ominus = \frac{(1-x-y)^3}{xy^3}$，……都有 $\frac{\left(\frac{1-x-y}{1+a} \right)^3}{\left(\frac{x+a}{1+a} \right) \left(\frac{y}{1+a} \right)^3} > \frac{(1-x-y)^3}{xy^3}$，
            \Corr 平衡时 $K^\ominus = \frac{(1-x-y)^2}{xy^3}$，……都有 $\frac{\left(\frac{1-x-y}{1+a} \right)^2}{\left(\frac{x+a}{1+a} \right) \left(\frac{y}{1+a} \right)^3} > \frac{(1-x-y)^2}{xy^3}$，
            \Thx{丁宗霖（福鼎市第一中学）}
        ...
        \item[第 345 页，习题 1.3 答案]
            \Orig \ce{20CsB3H8 -> 2Cs2B9H9 + 2Cs2B_{10}H_{10} + Cs2B_{12}H_{12} + 10CsBH4 + 35H2}
            \Corr \ce{16CsB3H8 -> 2Cs2B9H9 + Cs2B_{10}H_{10} + Cs2B_{12}H_{12} + 8CsBH4 + 28H2}
            \Thx{胡能源（东北育才学校）}
